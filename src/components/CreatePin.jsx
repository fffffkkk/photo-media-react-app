...
const CreatePin = ({ user }) => {
	...
	return (
		<div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
			{fields && (
				<p className='text-red-500 mb-5 text-xl transition-all duration-150 ease-in'>Add all files</p>
			)}
							...
							<label>
								<div className="flex flex-col items-center justify-center h-full">
									...
									<p className=" text-gray-400 mt-28">
										Use high-quality JPG, SVG, PNG, GIF less that 20 MB
									</p>
								</div>
								<input 
									type="file" 
          ...
          />
					<div className="flex flex-col">
						<div>
							<p className="mb-2 font-semibold text-lg sm:text-xl">Choose categories</p>
							<select
